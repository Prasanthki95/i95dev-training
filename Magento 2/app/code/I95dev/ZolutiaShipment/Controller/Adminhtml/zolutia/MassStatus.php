...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('zolutia');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('I95Dev\ZolutiaShipment\Model\Zolutia')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('zolutiashipment/*/index');
    }
